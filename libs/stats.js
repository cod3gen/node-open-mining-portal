...
//            client: rediscreateClient(redisConfig.port, redisConfig.host, redisConfig.password)
        ...
        async.each(redisClients, function(client, callback){
            ...
            Object.keys(allCoinStats).forEach(function(coin){
                ...
                for (var miner in coinStats.miners) {
                    ...
                    coinStats.miners[miner].hashrateString = _this.getReadableHashRateString(_workerRate, algo);
                }
            ...
            Object.keys(portalStats.algos).forEach(function(algo){
                ...
                algoStats.hashrateString = _this.getReadableHashRateString(algoStats.hashrate, algo);
            });
    ...
    this.getReadableHashRateString = function(hashrate, algo = null){
